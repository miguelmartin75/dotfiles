...
(defun is-eol ()
  "checks if the point is at the end of line"
  (= (point) (point-at-eol)))
  ...
  (if (and (org-at-item-p)
      ...
      (if (and (eolp)
        ...
        (cond
         ...
         ;; let org-mode figure it out if we are at the end of line
         ((is-eol) (org-meta-return))

         (t
          (progn (evil-delete-line (point) (point-at-eol))
                 (org-meta-return)
                 (evil-paste-after 1)
                 )
          )
